...
if not defined TC_TCTQL_HOME (
  echo Please initialize the environment variable TC_TCTQL_HOME to the location of your extracted Terracotta TCTQL kit
  pause
  exit /b 1
)
set TC_TCTQL_HOME=%TC_TCTQL_HOME:"=%
...
for /F "usebackq delims=" %%I in ( `dir /b /s "%TC_TCTQL_HOME%\*.jar"` ) DO set TC_CP=!TC_CP!;%%I
...
%JAVA% -cp "%TC_CP%" -Xmx200m StoreTextualQuerying

...
call "%TC_HOME%\server\bin\start-tc-server.bat" "-hostname" "localhost" "-license-file" "%TC_HOME%\license.xml" "-cluster-name" "tc-cluster" "-failover-priority" "availability" "-auto-activate"
